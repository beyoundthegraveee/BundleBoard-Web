...
export type GetCollectionQuery = { getCollectionById: { id: string, name: string, description: string, price: number, likesCount: number, isLiked: boolean, externalLink: string | null, author: { username: string, bio: string | null, rating: number | null, totalSales: number | null, downloadCount: number | null, avatarUrl: string | null, socialLinks: Array<{ platform: string, url: string }> }, galleryImages: Array<{ filePath: string }>, mediaResource: { fileName: string, fileSize: number, mimeType: MimeType, provider: Provider } } };
