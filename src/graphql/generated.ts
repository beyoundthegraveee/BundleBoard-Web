...
export type SearchCollectionsQuery = { searchCollections: Array<{ id: string, name: string, price: number, externalLink: string | null, slug: string | null, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetCollectionsPagedQuery = { getAllCollections: Array<{ id: string, name: string, description: string, price: number, externalLink: string | null, slug: string | null, author: { username: string, totalSales: number | null }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetCollectionBySlugQuery = { getCollectionBySlug: { id: string, name: string, description: string, price: number, videoTutorialUrl: string | null, externalLink: string | null, slug: string, likesCount: number, isLiked: boolean, author: { id: string, userId: string, bio: string | null, rating: number | null, totalSales: number | null, username: string, email: string, avatarUrl: string | null, socialLinks: Array<{ platform: string, url: string }> }, galleryImages: Array<{ fileName: string, filePath: string }> | null, mediaResource: { id: string, fileName: string, fileSize: number, mimeType: MimeType, provider: Provider } | null } };

export type GetLikedCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLikedCollectionsQuery = { getLikedCollections: Array<{ id: string, name: string, description: string, price: number, externalLink: string | null, slug: string | null, likesCount: number, isLiked: boolean, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> | null };
...
export type GetCollectionsByTagQuery = { getCollectionsByTag: { totalPages: number, totalElements: number, collections: Array<{ id: string, name: string, description: string, price: number, slug: string | null, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> | null } };
...
export type GetTopLikedCollectionsQuery = { getTopLikedCollections: Array<{ id: string, name: string, description: string, price: number, likesCount: number, isLiked: boolean, externalLink: string | null, slug: string | null, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetLatestCollectionsQuery = { getLatestCollections: Array<{ id: string, name: string, price: number, slug: string | null, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetSortedCollectionsQuery = { getSortedCollections: Array<{ id: string, name: string, description: string, price: number, likesCount: number, externalLink: string | null, slug: string | null, author: { username: string, totalSales: number | null }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetCommentsByUserIdQuery = { getCommentsByUserId: Array<{ id: string, content: string, createdAt: string, collection: { id: string, name: string, slug: string | null, author: { username: string } } }> };
...
export const GetCollectionBySlugDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCollectionBySlug"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"username"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCollectionBySlug"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"username"},"value":{"kind":"Variable","name":{"kind":"Name","value":"username"}}},{"kind":"Argument","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"videoTutorialUrl"}},{"kind":"Field","name":{"kind":"Name","value":"externalLink"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"likesCount"}},{"kind":"Field","name":{"kind":"Name","value":"isLiked"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"bio"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"totalSales"}},{"kind":"Field","name":{"kind":"Name","value":"socialLinks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"platform"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}},{"kind":"Field","name":{"kind":"Name","value":"galleryImages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fileName"}},{"kind":"Field","name":{"kind":"Name","value":"filePath"}}]}},{"kind":"Field","name":{"kind":"Name","value":"mediaResource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"fileName"}},{"kind":"Field","name":{"kind":"Name","value":"fileSize"}},{"kind":"Field","name":{"kind":"Name","value":"mimeType"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}}]}}]}}]}}]} as unknown as DocumentNode<GetCollectionBySlugQuery, GetCollectionBySlugQueryVariables>;
