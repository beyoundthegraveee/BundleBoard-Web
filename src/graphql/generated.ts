...
export type SearchCollectionsQuery = { searchCollections: Array<{ id: string, name: string, price: number, externalLink: string, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetCollectionsPagedQuery = { getAllCollections: Array<{ id: string, name: string, description: string, price: number, externalLink: string, author: { username: string, totalSales: number | null }, galleryImages: Array<{ filePath: string }> | null } | null> };
...
export type GetCollectionQuery = { getCollectionById: { id: string, name: string, description: string, price: number, likesCount: number, isLiked: boolean, externalLink: string | null, author: { username: string, bio: string | null, rating: number | null, totalSales: number | null, downloadCount: number | null, avatarUrl: string | null, socialLinks: Array<{ platform: string, url: string }> }, galleryImages: Array<{ filePath: string }> | null, mediaResource: { fileName: string, fileSize: number, mimeType: MimeType, provider: Provider } | null } };

export type GetLikedCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLikedCollectionsQuery = { getLikedCollections: Array<{ id: string, name: string, description: string, price: number, externalLink: string, likesCount: number, isLiked: boolean, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetTopLikedCollectionsQuery = { getTopLikedCollections: Array<{ id: string, name: string, description: string, price: number, likesCount: number, isLiked: boolean, externalLink: string, author: { username: string }, galleryImages: Array<{ filePath: string }> | null }> };
...
export type GetLatestCollectionsQuery = { getLatestCollections: Array<{ id: string, name: string, price: number, externalLink: string, galleryImages: Array<{ filePath: string }> | null }> | null };
...
export type GetSortedCollectionsQuery = { getSortedCollections: Array<{ id: string, name: string, description: string, price: number, likesCount: number, externalLink: string, author: { username: string, totalSales: number | null }, galleryImages: Array<{ filePath: string }> | null }> };
