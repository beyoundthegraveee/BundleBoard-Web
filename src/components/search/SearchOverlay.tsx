                          ...
                          {searchResults.map((item: CollectionItem) => {
                            ...
                            return (
                              <Link
                                ...
                                className={`group flex items-center justify-between p-3 sm:p-4 md:p-5 border border-border/30 bg-background/60 hover:bg-accent/80 hover:border-border/80 transition-all duration-300 rounded-none shadow-sm ${!hasValidSlug ? 'opacity-60 cursor-not-allowed' : ''}`}
                              >
                            ...
                            {latestCollections.map((item: CollectionItem) => {
                              ...
                              return (
                                <Link
                                  ...
                                  aria-disabled={!hasValidSlug}
                                  className={`group flex flex-col justify-between p-3 sm:p-5 border border-border/30 bg-background/40 hover:bg-accent hover:border-border/60 transition-all rounded-none ${!hasValidSlug ? 'opacity-60 cursor-not-allowed' : ''}`}
                                >
